...
const LikeIconComponent: FC<ILikeIconProps> = ({ isActive }) => {
  const fillColor = useMemo(() => (isActive ? 'red' : 'none'), [isActive]);
  const borderColor = useMemo(() => (isActive ? 'red' : '#C4C4C4'), [isActive]);
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill={fillColor}>
      <g id='like'>
        <mask id='mask0_1265_138' maskUnits='userSpaceOnUse' x='0' y='0' width='24' height='24'>
          <rect id='Rectangle 9' width='24' height='24' fill={borderColor} />
        </mask>
